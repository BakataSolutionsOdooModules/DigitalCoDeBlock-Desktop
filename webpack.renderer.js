    ...
    makeConfig(
        defaultConfig,
        {
            ...
            babelPaths: [
                ...
                /node_modules[\\/]+digitalcodeblock-[^\\/]+[\\/]+src/,
            ...
            plugins: [
                new CopyWebpackPlugin([{
                    from: path.join(getModulePath('digitalcodeblock-blocks'), 'media'),
                ...
                new CopyWebpackPlugin([{
                    from: path.join(getModulePath('digitalcodeblock-gui'), 'src', 'lib', 'libraries', '*.json'),
                    to: 'static/libraries',
                    flatten: true
                }])
            ]
