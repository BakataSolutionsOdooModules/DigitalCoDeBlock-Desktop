...
import locales from 'digitalcodeblock-l10n/locales/desktop-msgs';
...
const displayPermissionDeniedWarning = (browserWindow, permissionType) => {
    ...
    case 'camera':
        ...
        message = formatMessage({
            ...
            default: 'Permission to use the camera has been denied. ' +
                'DigitalCoDeBlock will not be able to take a photo or use video sensing blocks.',
    ...
    case 'microphone':
        ...
        message = formatMessage({
            ...
            default: 'Permission to use the microphone has been denied. ' +
                    'DigitalCoDeBlock will not be able to record sounds or detect loudness.',
    ...
    case 'darwin':
        instructions = formatMessage({
            ...
            default: 'To change DigitalCoDeBlock permissions, please check "Security & Privacy" in System Preferences.',
    ...
    default:
        instructions = formatMessage({
            ...
            default: 'To change DigitalCoDeBlock permissions, please check your system settings and restart DigitalCoDeBlock.',
    ...
    webContents.on('will-prevent-unload', ev => {
        const choice = dialog.showMessageBoxSync(window, {
            ...
            message: formatMessage({
                ...
                default: 'Leave DigitalCoDeBlock?',
                description: 'prompt for leave DigitalCoDeBlock'
            }),
            detail: formatMessage({
                id: 'index.questionLeaveDetail',
                default: 'Any unsaved changes will be lost.',
                description: 'detail prompt for leave DigitalCoDeBlock'
            }),
            buttons: [
                formatMessage({
                    id: 'index.stay',
